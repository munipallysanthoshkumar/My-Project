...
Original file is located at
    https://colab.research.google.com/drive/1XhVVv29eYWtFt6_Pqtw9YRN4P15_C4yN
...
model_densenet121 = models.Model(inputs, outputs, name="binary_densenet121")
...
checkpoint_path = f"{model_out}/binary_densenet121_best.weights.h5"
...
# ===== Evaluate =====
model_densenet121.load_weights(checkpoint_path)
...
val_results = model_densenet121.evaluate(
    val_ds,
    steps=len(val_gen_5),
    verbose=1
)
...
test_results = model_densenet121.evaluate(
    test_ds,
...
for x_batch, y_batch in test_ds.take(len(test_gen_5)):
    probs = model_densenet121.predict(x_batch, verbose=0).reshape(-1)
...
plt.imshow(cm)
plt.title("Confusion Matrix (DenseNet121 Binary OA Detection)")
